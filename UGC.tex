...
\begin{itemize}
\item UGC is used by news organizations daily and can produce stories that otherwise would not, or could not, be told. However, it
is often used only when other imagery is not available.
\item News organizations are poor at acknowledging when they are using UGC and worse at crediting the individuals responsible for
...
\item There are more similarities than differences across television and Web output, but troubling practices exist across both platforms.
\item The best use of UGC was online, mostly because the Web provides opportunities for integrating UGC into news output like
live blogs and topic pages.
\end{itemize}

\begin{The key findings to emerge from our interviews were:}
\begin{itemize}
\item News managers are often unaware of the complexities involved in the everyday work of discovering, verifying, and clearing rights for UGC. Consequently, staff in many newsrooms do not receive the training and support required to develop these skills.
\item With newsrooms under ever-increasing pressure, it is important that there are systematic procedures in place to provide clear guidance to output editors about which checks have been completed, and the level of confirmation regarding specific facts about footage.
\item There is a significant dependence on agencies to discover and verify UGC. Many newsrooms, particularly national news organizations, receive their UGC solely from agencies; often unaware of the content's origin, they don't realize that they are even using UGC, and think of it all simply as ``agency footage.''
\subsection{Conclusions}
\item The rise of UGC means many journalists' roles will change. Rather than being the sole bearers of truth, journalists will be required to allow more space for people to tell their own stories directly. News organizations must therefore face up to the challenge of deciding how best to manage this change.
\item Crediting practices need to improve; it will not be long before an uploader takes a news organization to court for using content without permission or for failing to attribute due credit. The result of any such case would have wide-reaching implications for the news industry.
\item As high-value UGC is increasingly licensed in the immediate aftermath of breaking news events, newsrooms should get used to paying for this content.
\item When putting out calls for action, newsgatherers need to use language that leaves uploaders without doubt that they must not, under any circumstances, put themselves at personal risk for the sake of capturing newsworthy UGC. Where required, training should be provided in this area.
\item News managers very quickly need to understand the full implications of integrating UGC into their output, with regard to its impact on their staff, their audiences, and the people who are creating the content in the first place.
\item Given the strong reliance on agencies to discover and verify UGC, news managers need to gain a stronger understanding of the practices employed by different agencies. This will enable them to ask appropriate questions about the provenance of a piece of UGC and the verification checks that have been undertaken.
\item The issue of vicarious trauma among staff who work with UGC is beginning to receive recognition as a serious issue, and news organizations must strive to provide support and institute working practices that minimize risk.
\end{itemize}

\chapter{Introduction}
It is just over five years since US Airways flight 1549 landed in the Hudson River in New York City. In the immediate aftermath, an incredible photograph
emerged of passengers crowding onto the wing, awaiting rescue. It originated from the Twitter account of Janis Krums, who had tweeted it out
to his 60 or so followers. At that point, only about 10 journalists worldwide knew how to find that picture, how to verify it, whether they needed to seek
permission to use it, and whether they had the right to put the picture on air or online. In the five years since 2009, newsgathering around breaking
news events has been revolutionized by the pictures and videos captured by eyewitnesses uploaded to social networks. The news industry has been
...
investing in UGC to tell different or better storiesâand this is starting to
have an impact.
There is a very significant reliance on news agencies to discover, verify,
and clear the rights for UGCâespecially for foreign stories. The number
...
work with UGC on a daily basis discuss its integration in a significantly different way than do their managers.
The journalists we spoke to about the integration of UGC raised six main
areas of concern:
\begin{enumerate}
\item \textbf{WORKFLOW}: Should newsrooms have staff dedicated to
the processing of UGC, or should the task be shared across
the newsroom?
\item \textbf{VERIFICATION}: Verifying UGC is considered a most pressing
challenge, particularly in the pressured context of breaking news.
\item \textbf{RIGHTS CLEARANCE}: The legal issues associated with copyright
...
\item \textbf{CREDITING}: Debates exist about whether on-air crediting is
necessary, with the added complication that some news
agencies that supply UGC do not provide any information about
the uploader.
\item \textbf{LABELING}: Labeling UGC is also a concern. While accidental
...
and consistently.
\item \textbf{RESPONSIBILITIES}: In the specific context of UGC, the ethical
responsibilities newsrooms must uphold for the uploaders,
the audience, and their own staff are numerous.
\end{enumerate}
These six areas of concern form the backbone of the way this report is organized. The strength of each of these as standalone topics encouraged us to create six digestible mini-reports.

One major tension runs throughout the research, however. That is the
debate about the role of the journalist as gatekeeper. A handful of interviewees talked about UGC as a crucial way of strengthening the relationship of newsrooms with their audiences, but were also very honest about how technology was threatening the established role of journalists. As one interviewee admitted, ``The crowd will many times think of something better than you do. And I think that's something we refuse to believe because it shakes the foundations of everything we [do] as gatekeepers.''
...
to be very judicious in the way we use this stuff and not let it take over the story.''
...
practices, or to illustrate stories that could not appear without pictures, was rarely discussed in our interviews.
...
considered a threat; that journalists are professional storytellers, and their role will always be to provide the necessary layer of verification, context, and a narrative framework. This tension will continue to impact discussions about UGC, and it is unsurprising that it runs throughout this research.

\section{Definition of User-Generated Content}
\begin{The phrase ``user-generated content'' is a catchall that can mean different
...
\section{What We Didn't Find}
\begin{Before we launch into our main research discoveries, we wanted to highlight
...
riverâthe one often used as the definitive example of UGC.
...
using it.'' Mark Little, then a foreign correspondent at the Irish public broadcaster RTE`, talked passionately of his personal frustration at not being sent
...
RTÃ and founded the social news agency Storyful.
...
UGC Hub, explained:
\begin{quote}[The year] 2011 was a very big watershed. Obviously you had the
...
would say, âNo, no, no, we don't do that with amateur material, but it has
...
this cycle:
\begin{quote}I think the use of UGC has inevitably gone up because we're in a more connected world. More of us have phonesâŠ and therefore more people
...
for this type of content, so now call it JGCâjournalist-generated content.
...
of footage, particularly from places where they are struggling to send their own reporters. This content type is included within our broad definition of
...
Part I reportâbut the main findings are included in this final report
as well.
...
decision, as we knew anecdotally that national half-hour news bulletin programs do not use UGC as commonly as do large, international rolling news
...
Our intention was to analyze seven full days of outputâ168 hours from
...
from each day for 21 days. We also rotated the start time, so on the first day we recorded from 8 a.m. to 4 p.m. GMT, on the second day from 4 p.m. to
...
\begin{tabular}{l l l}
\textbf{News Organization} & \textbf{Location of Headquarters} & \textbf{Language}\\
\hline
...
\caption{TABLE 1: News Organizations Included in the Quantitative Analysis}
\end{tabular}
...
professional skills could be identifiedâsuch as the way the camera panned
...
enabled us to reach a wide variety of global editors and journalistsâreach
...
\begin{The research showed that UGC is used across the 24-hour news industry
...
groups to report the Syrian conflict.^{\href{#endnotes}{5}} Indeed, for some news organizations Syria was the only story that included any type of UGC, and our interviewees emphasized the news organizations' total reliance on content from Syria because of the difficulties in using their own correspondents. However, our findings also highlighted a dependence on UGC at times when other pictures weren't available, such as in the very early stages of breaking news stories. For example, a helicopter crash in Glasgow happened very late at night (GMT) on November 29, 2013, and UGC featured heavily as the story broke. As professional pictures from their own camera crews or news agencies appeared on Saturday morning, broadcasters chose to update their packages and reports with these, replacing the UGC.
...
available, whereas others saw it as an invaluable resource for keeping stories alive, discovering different angles, and guaranteeing a diversity of voices and perspectives.
...
As TABLE 2 demonstrates, an average^{\href{#endnotes}{6}} of 11 pieces of UGC were used every
...
& \textbf{TV} &
&\textbf{7 Channels (excluding Al Jazeera Arabic)} & \textbf{Al Jazeera
Arabic only} & \textbf{Web}\\
\hline 
& 21 days sampled & 5 days sampled & 5 days sampled\\
Overall number of UGC pieces used & 1,858 & 257 &758\\
Average number of UGC pieces used per channel, per day & 11.06 & 51.04 & 18.95\\
Total number of minutes & 5 hours, 45 minutes & 1 hour, 9 minutes & N/A\\
Average length of each piece of UGC used & 11 seconds & 16 seconds & N/A\\
Average length of UGC used per channel per day & 2 minutes, 5 seconds  & 13 minutes, 36 seconds & N/A\\
\caption{TABLE 2: Amount of UGC Included in Coverage}
\end{tabular}
...
& & & TV Web &
\hline
& & Overall number of items & Daily average & Overall number of items & Daily average\\
High Use Channels & Al Jazeera Arabic & 257 & 51.4 & 55 & 11.0\\
& Al Jazeera English & 386 & 18.38 & 5 & 1.0\\
& BBC World 254 12.1 78 15.6\\
& CNN International & 356 &17.0 &4 50 & 90.0\\
& euronews & 415 &19.8 & 53 &10.6\\
& France & 24 & 270 & 12.9 & 114 & 22.8\\
Low Use Channels & NHK & 144 & 6.9 & 0 & 0\\
& Telesur & 34 & 1.6 & 3 & 0.6\\
Totals & & 2,115 & & 758 &\\
\caption{TABLE 3: Comparison of the Amount of UGC Used by News Organization}
\end{tabular}

In terms of Web output, CNN included the most UGC online. It is important
to stress, however, that this is partly because different websites had different numbers of links on each homepage. CNN had the most links out to stories from its homepage, with a daily average of 119, compared with 65 links to stories on BBC World and 13 links to stories on the NHK homepage.

The news websites had specific design features that encouraged depth and breadth in reporting. As one digital editor explained:
\begin{quote}There's the output between TV and there's the output between
...
\caption{FIGURE 1: ``UK Tidal Surge: As It Happened,'' BBC World, December 6, 2013}
\end{figure}

\begin The other format we investigated was topic pages. These pages had curated
...
\begin{figure}
\includegraphics{foldername/imagename.jpg}
\caption{FIGURE 2: CNN International Topic Pageâ``Crisis in Syria: The Refugees''}
\end{figure}

TABLE 4, however, shows that the main story types were similar.

\begin{tabular}{l c c}
\textbf{Story Type}&\textbf{TV}&\textbf{Web}
\hline
\end{tabular}
\begin{tabular}{l c c c c}
& Number of UGC pieces & \% of total & Number of UGC pieces & \% of total\\
Conflict/War Military & 925 & 44\% & 161 & 21\%\\
Explosion(terrorism or other causes) & 50 & 2\% & 9 & 1\%\\
Other & 281 & 13\% & 285 & 38\%\\
Protest & 364 & 17\% & 152 & 20\%\\
Vehicular crashes & 449 & 21\% & 80 & 11\%\\
Weather & 46 & 2\% & 71 & 9\%\\
Total & 2,115 & 100\%^{\href{footnote}{*}} & 758 & 100\%\\
\caption{TABLE 4: The Main Types of Stories Covered Using Some Form of UGC}
\end{tabular}
...
People had Taken During Vacations to North Korea,''^{\href{#endnotes}{9}} that were inundated with UGC.
...
\begin{quote}I think that there's still a big gap between digital and TV in the sense
...
not a weather story.
Another surprising finding from this analysis was the absence of viral videos. A viral video, one that reaches over a million views on YouTube in a
short period of time, typically involves a talented toddler, a cute animal, or a jaw-dropping sports stunt. In the period sampled, none of these types of
...
& \textit{Overall story} & \textit{Number of items} & \textit{Overall story} & \textit{Number of items}\\
\hline
1 & Syria & 842 & Syria & 155\\
2 & Glasgow helicopter crash & 349 & Egypt protests & 52\\
3 & Ukraine protests & 119 & Ukraine protests & 52\\
4 & Egypt protests & 99 & Glasgow helicopter crash & 49\\
5 & Black Friday (Thanksgiving) & 85 & Bangkok protests & 25\\
\caption{TABLE 5: The Specific Stories Covered Using Some Form of UGC}
\end{figure}
...
\begin{figure}
\includegraphics{foldername/imagename.jpg}
\caption{FIGURE 3: Comparison of the Amount of UGC Used on Television Over the 21-day Period}
\end{figure}

\begin{figure}
\includegraphics{foldername/imagename.jpg}
\caption{FIGURE 4: The Top Stories Including UGC on the Web}
\end{figure}
...
\begin{enumerate}
\item\textit{UGC was used to tell the story of the Syrian conflict almost
every day.}
...
\begin{quote}
``I wonder---when all [the audience is] seeing is continuous Syriaâif
...
news events.
\item\textit{During breaking news stories, UGC fills the gap while news
...
social media.''
\end{quote}
\item\textit{UGC is used when no other pictures exist.}
...
hubâbroadcasters either had their own camera people there or relied on
...
be more interesting.''
\end{quote}
\item\textit{UGC was used as part of news programs dedicated to the Web.}
...
were using UGCâby either failing to label or credit appropriatelyâthese
...
networks that, during an episode of \textit{The Stream} about Nelson Mandela's
...
Elsewhere, France 24's \textit{Les Observateurs}, a program entirely dedicated to
...
someone standing in front of a cameraâyou know, your average white bloke
in a tieâyou have something handheld and jerkyâŠ It makes it feel more
...
teams there in Ukraineâa couple of correspondents and representativesâ
...
thought, âI'll have a look in the World Service contacts [directory],' but I feel
...
the victims are often smaller in numbersâsmaller numbers than
...
there is normally a team of people (or even just one person) seen as having more expertise in handling UGC. These journalists are much more likely
...
\item \textit{Newsrooms encourage people to send photos or videos directly.}
...
\item \textit{Newsrooms find content shared on social networks.}
...
from Twitter.
\item\textit{News agencies play a role.}
...
agency. ``We do get clients flagging stuff up to us, [saying], âHave you seen
this?'âŠ We want to be belt and braces certain of something before we use
...
\ldots They can be stills, video, blogs, so it's totally integrated for us in
...
\section{Verification Processes}
...
Storyful verifies the source, date, and location of each video separatelyâ
...
writing a wire story [\ldot so] we wouldn't do an additional verification
...
\section{Verification and the Audience}
...
\begin{quote}``I would say that, for example, with the barrel bombings [in Syria]
...
UK's ``no-makeup selfies'' campaign.^{\href{#endnotes}{26}} The pictures were public because they had been posted on Twitter, but publishing them on a news website seemed to change the context considerably for the journalists to whom we spoke. Some people suggested that they would like users to get an automated alert
...
based in Asia described the way that ``laws that govern UGC and copyrights in our region tend to be a bit murky.'' In Sweden, legal responsibility lies
...
remind them that it was unlikely he would even be able to replyâas ``there
was still no power in Tacloban City.''

Another significant problem is that uploaders themselves often don't know
their own rights, and don't understand enough about the news businessâ
...
run with pictures before getting clearance] is a risk calculation on the broadcasters' part, because they know that we're working on getting the clearance, so they're thinking, `The clearance will come. Let's just run it.' ''
...
up the producer and said, `If you can find anybody who had a video camera on board that ship, then buy the material.' I said, `You need a contract from
...
As one former producer admitted, ``Actually the rule has always been, âWe've
...
later, we got an invoice for Â£350. But we've got a screen grab of [our
...
out by CNN and the like, which, he said gave him little credit and no compensation of his contribution to history.''^{\href{#endnotes}{28}}
...
\begin{figure}
\includegraphics{foldername/imagename.jpg}
\caption{FIGURE 5: Conversations Between a Reuters Journalist and Uploader Jan Hollands About Using Her Photo}
\end{figure}
...
\begin{figure}
\includegraphics{foldername/imagename.jpg}
\caption{FIGURE 6: The Dopesheet Circulated by Reuters with a Picture Sourced From Twitter}
\end{figure}
...
tend to see it as, not `How can I nick it?' but `How can I use that on my [television news bulletin or website]?' without actually thinking, `How do we use
...
be used for free by news organizations for 24 hours.^{\href{#endnotes}{29}} Any subsequent use, either in longer packages, documentaries, or within archives would require specific permission from the uploader. In addition, if organizations wanted to syndicate the content, they would need to establish a separate agreement with the uploader.
...
\end{tabular}
\begin{tabular}{l c c c c}
& \% & Total number of pieces of UGC & \% & Total number of pieces of UGC\\
\textbf{Al Jazeera English} & 1\% & 386 & 100\% & 5\\
\textbf{BBC World} & 9\% & 254 & 49\% & 78\\
CNN International & 53\% & 355 & 79\% & 450\\
euronews & 15\% & 415 & 13\% & 53\\
France 24 & 1\% & 270 & 15\% & 114\\
NHK & 4\% & 144 & 0\% & 0\\
Telesur & 0\% & 34 & 0\% & 3\\
\caption{TABLE 6: Who Added Credits to the Content?^{\href{#endnotes}{30}}}
\end{tabular}
...
Similarly, UGC content that featured on France 24's \textit{Les Observateurs}, a
...
was ongoing at the time. The credit on the picture used was \textit{The Sun} newspaper,
which was the news organization that had purchased the UGC. \textit{The
Sun} had burned in a large logo so it was guaranteed credit.
\begin{figure}
\includegraphics{foldername/imagename.jpg}
\caption{FIGURE 7: BBC World Used UGC Purchased by \textit{The Sun} Newspaper}
\end{figure}

In early May of 2014 the \textit{Herald Sun}, a newspaper owned by News Corp,
...
the \textit{Herald Sun} employees burned on their own watermarks in a way
...
\begin{figure}
\includegraphics{foldername/imagename.jpg}
\caption{FIGURE 8: Watermarked Pictures Published by the \textit{Herald Sun} on Twitter}
\end{figure}
...
you call, they'll say, ``I only want [the photo] on one bulletin. I don't want to see it anywhere else, and I need credit.'' Or they may have
...
number of pieces of content that weren't credited, there is certainly a disconnect between what newsrooms think they should be doing, what managers
think is happening, and what is actually happening.

\item\textit{Role of the Agencies}
...
media website.'' \ldot So for Reuters, our whole reputation depends on
...
breaking news situation, you are much more likely to think about giving them credit. When you are removed from that process, and the pictures
...
which has a space to fill in a name and location, or name and date, etc. So we could do with a rule that a producer using UGC should
...
\item\textit{The Complexities of Syria}
...
and there are fewer and fewer and fewer people to do the jobâŠ You
...
they must do, not something that's \textit{nice} to do if you remember.''
...
\begin{tabular}{l c c}
& \textbf{TV} & \textbf{Web}
\textbf{Percentage of UGC that was not labeled as UGC} & 72\% & 30\%\\
\caption{TABLE 7: Percentage of UGC Not Labeled as UGC}
\end{tabular}
...
news channels now. On Al Jazeera English, it was \textit{The Stream], on BBC
World, it was \textit{BBC Trending}, on France 24 there are two: \textit{Les Observateurs}
and \textit{Sur Le Net}. These programs would play a YouTube video showing the
...
\begin{tabluar}{l c c c c}
& & \textbf{TV} & \textbf{Web}
\textbf{Al Jazeera English} & 60 & 386 & 100 & 5\\
\textbf{BBC World} & 81 & 254 & 49 & 78\\
\textbf{CNN International} & 51 & 355 & 79 & 450\\
\textbf{euronews} & 85 & 415 v13 & 53\\
\textbf{France} & 24 75 270 & 15 & 114\\
\textbf{NHK World} & 97 144 & 0 & 0\\
\textbf{Telesur} & 100 & 34 & 0 & 3\\
\caption{TABLE 8: Who Added Descriptive Labels to UGC?}
\end{tabular}

There were a number of different ways that broadcasters labeled UGC; euronews tended to use the caption ``amateur video'':

\begin{figure}
\includegraphics{foldername/imagename.jpg}
\caption{FIGURE 9: Screen grab From a Broadcast by euronews During our Sample Period}
\end{figure}
...
\begin{figure}
\includegraphics{foldername/imagename.jpg}
\caption{FIGURE 10: Screen grab From a Broadcast by Al Jazeera English During our Sample Period}
\end{figure}
...
captured by someone unrelated to the newsroom. But there was an overall sense that people who capture and upload content often have an agenda,
...
wrong. But at least we said, ``This is what this picture says it is.'' I think this helps to some degree, but it doesn't totally excuse you.''
\end{quote}
...
Al Jazeera made a conscious editorial decision to label videos from Syria as ``YouTube.com/Activist Video.'' As one of its presenters argued, ``We used to just say, `YouTube.com.' Now it's `YouTube.com/Activist Video.' That was a conscious decision made. This is activist video. Take it. We will explain it as best we can, but remember where it came from and I think that was a very good thing to do.''
...
the credit. The AP does not reference the platform, arguing it is simply the delivery mechanism and will only reference the platform if it believes it is
...
all of this much easier, but with television it is more of a challenge, particularly when different regulations govern public service versus commercial
...
\section[\begin{enumerate}{\item{]Responsibility Toward Uploaders}}
\subsection\textit{Health and Safety}
...
better ones. They were told not to do so, as they were putting themselves in danger. This forced the BBC to rethink its processes around UGC, and it
...
they've posted the image, by me saying, âHello, can I use it? I'm from the
...
for photos after someone has died, that they copy and then sell onto newsrooms desperate for images. Reuters has a blanket policy of not using
...
a big ethical issue is---what are the rights of the owner of the content, not just the rights of the content itself? What are their rights to privacy? What
...
\section{\item{Responsibility to the Audience}}
\subsection\textit{Distressing Images}
...
the lawyers at ITN and senior editorial people would just say, âNo way,
...
complaints.^{\href{#endnotes}{37}} However, as one of our interviewees discussed, it is unlikely that a traditional news camera would have been able to capture this type of footage:
...
\end{quote}
\subsection\textit{Need for a Standardized Set of Guidelines?}
...
thinking of a sensible way of treating UGC \ldot I think some organizations
...
\section{\item Responsibility to Staff}
\subsection\textit{Vicarious Trauma}
...
responsibility \ldot But at the same time I have to protect myself from it.'' The
\begin{quote}
...
published in the \textit[Journal of the Royal Society of Medicine}, Professor Anthony Feinstein and his two colleagues examined the potential impact of viewing
...
to anxiety, depression, PTSD, or alcohol consumption.'' The research also demonstrated that frequency, rather than duration of exposure to images of
...
often dealing with people who have just witnessed something newsworthyâ
...
and gore \ldot people are desensitized. You start to lack empathy, and as a
journalist or editor you don't support a story just because [you] don't understand the real human impact of it, because [you've] just seen it so often.''
...
pictures aren't available; whether that's from a conflict zone where journalists can't enter, or eyewitness footage from a breaking news event.
...
Our data certainly showed more similarities than differences across television and Web output, with troubling practices across both platforms. The best use of UGC was online, mostly because the Web provides opportunities
...
detail the processes through which UGC has to travelâproviding necessary
...
from the reality of the everyday work that is involved with discovering, verifying, and clearing the rights for UGC. Therefore, in many newsrooms the
...
mandatory crediting guidelines, updates to editorial policies about labeling UGC based on the agenda of the uploader, or the necessary improvements
...
through necessity. The complexity of these skills are not yet necessarily recognized at a managerial level.^{\href{#endnotes}{40}}
...
say this particularly with regard to the impact on their staff, their audiences, and the people who are creating the content in the first place.
...
\being{enumerate}
\item Unless crediting practices improve, an uploader will take a news
...
\item The current way that UGC is being discovered and used will change
...
\item The processes needed to verify digital content require specific
...
that verification is a processânot a true/false distinctionâand
they need to know which questions to ask of the producers who have
undertaken the process.
\item News organizations' reliance on agencies to discover and verify
...
undertaken. Journalists also need to know how to recognize that a piece distributed by agencies is UGC through dopesheets so they
know they are indeed working with UGC and can add additional
labels to ensure maximum transparency for the audience.
\item An academic study by Professor Anthony Feinstein and colleagues
(to be published in the \textit{Journal of the Royal Society of Medicine} very soon)^{\href{#endnotes}{41}} compares self-reported psychological measures of journalists who work on domestic desks with journalists who work on UGC desks and frequently in conflict zones. The main feature to emerge
...
\item News organizations' clarity in their public calls to action is a crucial element of the training needed for staff working with UGC. As
...
\item For some journalists, their roles will change. They are no longer
...
We would also like to expand this research by studying whether similar patterns appear within newspaper organizations. Large newspaper sites are
...
designed to be conversation starters---hopefully a catalyst for some industry-wide meetings where journalists, representatives from social networks,
...
very easy for outsiders to write a report full of suggestions that are ultimately unworkable within the everyday context of a pressured breaking
...
\section\textbf{Recommendations for the Entire News Industry:}
\begin{itemize}
...
\chapter{List of Interviewees}

\begin{tabular}{l l l l}
Interviewee & Organization & Job title & Location\\
\hline 
Ahmet Jaffari & Radio Free Iraq & Senior Correspondent & Iraq\\
Alan Soon & Yahoo! & Head of News, SE Asia & Singapore\\
Alan Sunderland & ABC & Head of Editorial Policy & Australia\\
Andrew Moon & ABC & Social Media Producer & Australia\\
Anna Doble & Channel 4 News & Head of Online & UK\\
Asha Phillips & Storyful Asia & Editor & Hong Kong\\
Atte Jääskeläinen & YLE & Director of News \& Current Affairs & Finland\\
Ay¸se Alibeyo˘glu & Al Jazeera English & Deputy News Editor & Qatar\\
BamBang Harymurti & Tempo & Editor in Chief & Indonesia\\
Belen López & Garrido Eurovision News & Editor & Switzerland\\
Bob Hughes & TV3 & Deputy Director of News & Ireland\\
Byron Perry & Coconuts Media & Founder \& MD & Thailand\\
Carol Hall & BBC & Head of Rights & UK\\
Caroline Bannock & Guardian Community & Coordinator, GuardianWitness & UK\\
Chris Hamilton & BBC & Social Media Editor & UK\\
Christian Fougner & NRK & Assistant News Editor & Norway\\
Cordelia Heblethwaite & BBC Trending & Journalist & UK\\
Cynara Vetch & CCTV Africa & New Media Manager & Kenya\\
David Clinch & Storyful & Executive Editor & USA\\
David Doyle & Channel 4 News & Specialist Producer & UK\\
David Waddell & BBC & Senior Producer & UK\\
Deborah Rayner & CNN & VP and Managing Editor EMEA & UK\\
Derl McCrudden & AP Television News & Head of Newsgathering & UK\\
Dick Jansen & NOS & Head of the Foreign Desk & Netherlands\\
Ed Fraser & Channel 4 News & Managing Editor & UK\\
Elmar Thevessen & ZDF & Editor in Chief & Germany\\
Esra Do˘gramaci & BBC World Service & Digital Consultant & UK\\
Fergus Bell & AP Television News & Social Media and UGC Editor – International & UK\\
Fiona Conway & CBC News & Executive Director of News Programs & Canada\\
Fiona Dodd & ITN & Head of News Syndication & UK\\
Fran Unsworth & BBC & Deputy Director of News & UK\\
Geertje Bal & VRT & Foreign Desk Coordinator & Belgium\\
Gudrun Gutt & ORF & Head of Newsgathering & Austria\\
Ian Ferguson & Sky News Australia & Director of News and Programs & Australia\\
Ingólfur Bjarni Sigfússon & RUV & Head of Online and New Media & Iceland\\
Ivor Crotty & Russia Today & Head of Social Media & Russia\\
Jason Mills & ITV News & Head of Digital & UK\\
John Crowley & Wall Street Journal & Digital Editor & UK\\
John Ludlam & Reuters Television & Editor of the Day & UK\\
Jose Miguel Sardo & euronews & News Media Editor & France\\
Julien Pain & France 24 & Senior Editor & France\\
Kamahl Santamaria & Al-Jazeera English & News Anchor & Qatar\\
Kate Torney & ABC Australia & Director of News & Australia\\
Kevin Bakhurst & RTÉ & MD of News and Current Affairs & Ireland\\
Maria Ressa & Rappler & CEO & Philippines\\
Michael Herrod & ITN & Foreign Editor & UK\\
Michael Wegener & ARD & Head of Content Center & Germany\\
Olov Carlsson & SVT & Director of News and Sports vSweden\\
Pat Whitehorne & BBC & Assistant Editor, UGC Hub & UK\\
Peter Barabas & euronews & Editor in Chief for News & France\\
Philippa McDonald & ABC & Senior Reporter & Australia\\
Rachel Kennedy & BBC & Assistant Editor, BBC News Channel & UK\\
Richard Porter & BBC & World Controller of English & UK\\
Safiullah Gul Dawn & TV Waziristan & Bureau Chief & Pakistan\\
Sarah Marshall & Wall Street Journal & Social Media Editor, EMEA & UK\\
Scott Pham & NBC Bay Area & Digital Editor & USA\\
Shiv Malik & Guardian & Reporter & UK\\
Simon Ward & BBC & Assignment Editor & UK\\
Soheil Afdjei & Reuters Television & EMEA News Editor & UK\\
Sue Llewellyn & Ultra & Social Co-founder & UK\\
Tahrier Hijazi & Eurovision & Producer & Switzerland\\
Take Kusaba & NHK & Director, Media Strategy & Cooperation & Japan\\
\end{tabular}
...
Media in Global Context, ed. A. Sreberney-Mohammadi et al. (London: Arnold, 2003), 145â160.\\
...
the BBC's Coverage of the Events Known as the âArab Spring,''' 2012,
http://downloads.bbc.co.uk/bbctrust/assets/files/pdf/our_work/
arabspring_impartiality/arab_spring.pdf.\\
BBC Trust, ``A BBC Trust Report on the Impartiality and Accuracy of
the BBC's Coverage of the Events Known as the âArab Spring': Follow Up
...
pics.\\
M.T. HÃ€nska-Ahy and R. Shapour, ``Who's Reporting the Protests?''
Journalism Studies, 13:1 (2012): 1â17.\\
...
British Newspaper Websites,'' Journalism Practice 2(3) (2008): 343â356.
...
A.M. JÃ¶nnson and H. Ãrnebring, ``User-generated Content and the News:
...
University of Westminster, 2008), 24â41. https://www.westminster.ac.uk/_data/assets/pdf_file/0005/20021/003WPCC-Vol5-No2-Paulussen_Ugille.pdf.\\
...
Media, Culture & Society, 2010, 781â799.\\
